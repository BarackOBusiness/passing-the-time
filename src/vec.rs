...
// Abstractions to vec3, for organizational purposes
...
impl Index<usize> for Vec3 {
    ...
    // Return a reference to the f64 indexed
...
impl IndexMut<usize> for Vec3 {
    // The same thing but it's a mutable reference instead
...
impl AddAssign for Vec3 {
    // Assigns the resultant value to the self being operated on
