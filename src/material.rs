...
// I'm not sure if this implementation of hemispheral diffuse is correct in the new material module
...
impl Dielectric {
    pub fn new(index_of_refraction: f64) -> Dielectric {
        Dielectric { ior: index_of_refraction }
    }

    fn reflectanace(cosine: f64, ref_idx: f64) -> f64 {
...
impl Scatter for Dielectric {
    fn scatter(&self, r_in: &Ray, rec: &HitRecord) -> Option<(Color, Ray)> {
        ...
        let will_reflect = rng.gen::<f64>() < Self::reflectanace(cos_theta, refraction_ratio);
